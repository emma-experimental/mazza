(function () {
  ...
  // === CONFIGURATION (User sets via window.ChatWidgetConfig) ===
  const config = window.ChatWidgetConfig || {
    webhookUrl: 'https://pranav-the-emperor.onrender.com/webhook-test/5dbd934f-fefc-4420-a3c4-3c250df6bfde', // e.g., https://your-n8n.onrender.com/webhook/chat
    companyName: 'Pranav',
    companyLogo: 'https://imageio.forbes.com/specials-images/imageserve/67e252b93cf4dd3365504649/AI-agents-represent-the-next-evolutionary-leap-beyond-generative-AI--capable-of/960x0.jpg?format=jpg&width=960',
    primaryColor: '#10b981',
  };
  ...
  startChatBtn.addEventListener('click', () => {
    ...
    // Send first message with user info
    showTyping();
    sendToN8n({
      name,
      email,
  ...
  function sendMessage() {
    ...
    // Send message with same user data (session handled by n8n)
    sendToN8n({
